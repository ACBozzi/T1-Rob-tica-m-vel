...
total_label, total_data = Obter_Todos_Batch()
...
k, k_opt, k_values, variance_values = Calcular_Best_K_OPT()
...
pca = PCA(n_components=Calcular_Best_K(), whiten=True)
...
ConfusionMatrixDisplay(confusion_matrix=confusion_matrix(label_test, y_pred_knn), display_labels=total_label[0]).plot()
plt.grid(False)
plt.show()
